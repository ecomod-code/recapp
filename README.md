...
Recapp is a collaborative quiz tool designed for teaching. It is built around a
...
Participation works either via OpenID Connect accounts or anonymously via
browser fingerprint — no registration required for guests.

## Documentation

- **[User Guide](https://ecomod-code.github.io/recapp/)** — how to use Recapp as a teacher or student.
- **[Installation Guide](INSTALLATION.md)** — self-hosting Recapp on your own server (Docker Compose + Caddy).

## Contributing

**recapp** is a free and open-source project. Therefore, we warmly welcome your suggestions, bug reports, or, in the best case, code contributions! For more information, see [CONTRIBUTING](CONTRIBUTING.md).
...
*The development of RECAPP was funded by the Lower Saxony Ministry of Science and Culture (Niedersächsisches Ministerium für Wissenschaft und Kultur). Initial development took place at the University of Göttingen.*
